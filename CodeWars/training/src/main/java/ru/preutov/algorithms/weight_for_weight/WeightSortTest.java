...
public class WeightSortTest {
    ...
    public void BasicTests2() {
        System.out.println("****** Basic Tests for v2 ******");
        assertEquals("2000 103 123 4444 99", WeightSort.orderWeight2("103 123 4444 99 2000"));
        assertEquals("11 11 2000 10003 22 123 1234000 44444444 9999", WeightSort.orderWeight2("2000 10003 1234000 44444444 9999 11 11 22 123"));
    }
}
